...
void ConfigureAllRegisters()
{
	...
	// ISP_CTRL	
	/////////////////////////////////////////////
	WordPtr = (unsigned int *)(src+ISP_CTRL);											// The Address
	WordValue = 0x00C12900;																// The Value
	*WordPtr = WordValue;
	...
	// CCDC_SYNC_MODE	
	/////////////////////////////////////////////
	WordPtr = (unsigned int *)(src+CCDC_SYN_MODE);										// The Address
	WordValue = 0x00030401;																// The Value
	*WordPtr = WordValue;
	...
	// CCDC_PIX_LINES	
	/////////////////////////////////////////////
	WordPtr = (unsigned int *)(src+CCDC_PIX_LINES);										// The Address
	WordValue = 0x00807D01;																// The Value
	*WordPtr = WordValue;
	...
	// CCDC_HORZ_INFO	
	/////////////////////////////////////////////
	WordPtr = (unsigned int *)(src+CCDC_HORZ_INFO);										// The Address
	WordValue = 0x0001007F;																// The Value
	*WordPtr = WordValue;
	...
	// CCDC_VERT_START	
	/////////////////////////////////////////////
	WordPtr = (unsigned int *)(src+CCDC_VERT_START);									// The Address
	WordValue = 0x00010001;																// The Value
	*WordPtr = WordValue;
	...
	// CCDC_HSIZE_OFF	
	/////////////////////////////////////////////
	WordPtr = (unsigned int *)(src+CCDC_HSIZE_OFF);										// The Address
	WordValue = 0x00000100;																// The Value
	*WordPtr = WordValue;
	...
	// CCDC_VDINT	
	/////////////////////////////////////////////
	WordPtr = (unsigned int *)(src+CCDC_VDINT);											// The Address
	WordValue = 0x00011F41;																// The Value
	*WordPtr = WordValue;
	...
	// CCDC_FMTCFG	
	/////////////////////////////////////////////
	WordPtr = (unsigned int *)(src+CCDC_FMTCFG);										// The Address
	WordValue = 0x00000000;																// The Value
	*WordPtr = WordValue;
